...
func (v *customValidator) validate(ctx context.Context, nhc *remediationv1alpha1.NodeHealthCheck) error {
	aggregated := errors.NewAggregate([]error{
		remediationv1alpha1.ValidateMinHealthyMaxUnhealthy(nhc),
...
func (v *customValidator) validateSelector(nhc *remediationv1alpha1.NodeHealthCheck) error {
...
func (v *customValidator) validateMutualRemediations(nhc *remediationv1alpha1.NodeHealthCheck) error {
...
func (v *customValidator) validateEscalatingRemediations(ctx context.Context, nhc *remediationv1alpha1.NodeHealthCheck) error {
...
func (v *customValidator) validateEscalatingRemediationsUniqueOrder(nhc *remediationv1alpha1.NodeHealthCheck) error {
...
func (v *customValidator) validateEscalatingRemediationsTimeout(nhc *remediationv1alpha1.NodeHealthCheck) error {
	for _, rem := range nhc.Spec.EscalatingRemediations {
...
func (v *customValidator) validateEscalatingRemediationsUniqueRemediator(ctx context.Context, nhc *remediationv1alpha1.NodeHealthCheck) error {
...
func isRestrictedFieldUpdated(nhc, old *remediationv1alpha1.NodeHealthCheck) (bool, string) {
...
func isRemediating(nhc *remediationv1alpha1.NodeHealthCheck) bool {
